...
def createlv():
    global player, lvvll;
    lvvll = newlevel((13, 11), "root", color=(150, 0, 214));
    ...
    lvvll.add(obj("wall"), (1, 10));
    lvvll.add(obj("lock", "5"), (1, 7));
    lvvll.add(obj("lock", "3"), (1, 6));
    lvvll.add(obj("lock", "2"), (1, 5));
    lvvll.add(obj("wall"), (1, 0));
    lvvll.add(obj("wall"), (2, 10));
    lvvll.add(obj("key", "2"), (2, 8));
    lvvll.add(obj("key", "2"), (2, 7));
    lvvll.add(obj("wall"), (2, 5));
    lvvll.add(obj("key", "+"), (2, 3));
    lvvll.add(obj("key", "="), (2, 2));
    lvvll.add(obj("wall"), (2, 0));
    lvvll.add(obj("wall"), (3, 10));
    lvvll.add(obj("key", "+"), (3, 8));
    lvvll.add(obj("key", "2"), (3, 7));
    lvvll.add(obj("wall"), (3, 5));
    lvvll.add(obj("wall"), (3, 0));
    lvvll.add(obj("wall"), (4, 10));
    lvvll.add(obj("key", "2"), (4, 8));
    lvvll.add(obj("key", "2"), (4, 7));
    lvvll.add(obj("wall"), (4, 5));
    lvvll.add(obj("key", "="), (4, 3));
    lvvll.add(obj("key", "2"), (4, 2));
    lvvll.add(obj("wall"), (4, 0));
    lvvll.add(obj("wall"), (5, 10));
    lvvll.add(obj("wall"), (5, 5));
    lvvll.add(obj("key", "*"), (5, 3));
    lvvll.add(obj("key", "="), (5, 2));
    lvvll.add(obj("wall"), (5, 0));
    lvvll.add(obj("wall"), (6, 10));
    lvvll.add(obj("wall"), (6, 9));
    lvvll.add(obj("wall"), (6, 8));
    lvvll.add(obj("wall"), (6, 7));
    lvvll.add(obj("wall"), (6, 6));
    lvvll.add(obj("wall"), (6, 5));
    lvvll.add(obj("key", "-"), (6, 3));
    lvvll.add(obj("key", "+"), (6, 2));
    lvvll.add(obj("wall"), (6, 0));
    lvvll.add(obj("wall"), (7, 10));
    lvvll.add(obj("wall"), (7, 0));
    lvvll.add(obj("wall"), (8, 10));
    lvvll.add(obj("lock", "-"), (8, 2));
    lvvll.add(obj("lock", "2"), (8, 1));
    lvvll.add(obj("wall"), (8, 0));
    lvvll.add(obj("wall"), (9, 10));
    lvvll.add(obj("lock", "4"), (9, 9));
    lvvll.add(obj("wall"), (9, 8));
    lvvll.add(obj("wall"), (9, 7));
    lvvll.add(obj("wall"), (9, 6));
    lvvll.add(obj("wall"), (9, 5));
    lvvll.add(obj("wall"), (9, 4));
    lvvll.add(obj("lock", "2"), (9, 3));
    lvvll.add(obj("wall"), (9, 2));
    lvvll.add(obj("lock", "4"), (9, 1));
    lvvll.add(obj("wall"), (9, 0));
    lvvll.add(obj("wall"), (10, 10));
    lvvll.add(obj("lock", "9"), (10, 9));
    lvvll.add(obj("wall"), (10, 8));
    lvvll.add(obj("key", "2"), (10, 6));
    lvvll.add(obj("key", "2"), (10, 5));
    lvvll.add(obj("key", "2"), (10, 4));
    lvvll.add(obj("wall"), (10, 2));
    lvvll.add(obj("lock", "6"), (10, 1));
    lvvll.add(obj("wall"), (10, 0));
    lvvll.add(obj("wall"), (11, 10));
    lvvll.add(obj("wall"), (11, 8));
    lvvll.add(obj("wall"), (11, 2));
    lvvll.add(obj("wall"), (11, 0));
    lvvll.add(obj("wall"), (12, 10));
    lvvll.add(obj("wall"), (12, 9));
    lvvll.add(obj("wall"), (12, 8));
    lvvll.add(obj("wall"), (12, 7));
    lvvll.add(obj("wall"), (12, 6));
    lvvll.add(obj("wall"), (12, 5));
    lvvll.add(obj("wall"), (12, 4));
    lvvll.add(obj("wall"), (12, 3));
    lvvll.add(obj("wall"), (12, 2));
    lvvll.add(obj("wall"), (12, 1));
    lvvll.add(obj("wall"), (12, 0));
    lvvll.add(obj("win"), (11, 1))
    lvvll.add(obj("win"), (11, 9))
    lvvll.add(obj("key", "3"), (7, 6))
    lvvll.add(obj("lock", "1"), (10, 3))
    player = (2, 3)
createlv(); save("w1-6.lv")
#load("level.lv")
#load("w1.lv")
