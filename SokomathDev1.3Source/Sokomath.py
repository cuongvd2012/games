...
wons={}
progress=set()
bgobjs={"win", "lv", "star", "unstar", "oneway", "sign"}
lvhistory=["hub", "w1", "w1-1"]
removee=set()
class lv:
...
def drawlevel(name, x, y, scaley, frame=0):
    ...
    pygame.draw.rect(w, (0, 0, 0), pygame.Rect(math.floor(x+tilesizex*player[0]-tilesizex*0.025), math.floor(y+tilesizey*player[1]-tilesizey*0.025), math.ceil(tilesizex+tilesizex*0.025), math.ceil(tilesizey+tilesizey*0.025)), border_radius=int(tilesizex*0.2), width=int(tilesizex*0.175))
...
def createlv():
    global player, lvvll;
    lvvll = newlevel((12, 10), "root", color=(3, 34, 168));
    ...
    lvvll.add(obj("lv", ("w2-7-99", "99")), (7, 1));
    player = (3, 7)
#createlv(); save("assets/w2-7.lv")
load("assets/w1-1.lv")
