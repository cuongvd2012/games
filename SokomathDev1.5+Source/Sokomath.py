...
pygame.display.set_icon(pygame.image.load("assets/logolow.png"))
logo=pygame.image.load("assets/logo.png")
logorect=logo.get_rect(center=(400, 300))
...
def fade(ff):
    global fit
    surf=pygame.Surface((w.get_width(), w.get_height()))
    surf.fill((0, 0, 0))
    for alpha in range(0, 256, int(255/20)):
        ...
        clock.tick(60)
    ff()
    for alpha in range(255, -1, -int(255/20)):
        surf.set_alpha(alpha)
        w.fill((0, 0, 0))
...
def drawlevel(name, x, y, scaley, frame=1, playeranim=(0, 0)):
    ...
    for pos, (id, typee) in lvs[name].bg.items():
        ...
        if typee.type=="sign":
            ...
            if pos==player:
                lines=["Hub" if typee.value[1]=="H" else f"Level {str(int(typee.value[1]))}" if "w" not in typee.value[1] else f"World {typee.value[1][1:]}", "[Space] to enter"]
                lh=font2.get_linesize()
                for j, line in enumerate(reversed(lines)):
                    surf=font2.render(line, False, (255, 255, 255))
                    surf2=font2.render(line, False, (0, 0, 0))
    ...
    for pos, (idd, typee) in list(lvv.bg.items()):
        if typee.type=="win":
            if player==pos:
                ...
                def wiin():
                    global player, lvhistory, animation, move
                    pygame.mixer.Sound("assets/win.mp3").play()
                    if len(lvhistory)==1:
                        lvhistory=[("outhub", (2, 13))]+lvhistory
                    load("assets/levels/"+lvhistory[-2][0]+".lv")
                    player=lvhistory[-1][1]
                    lvhistory.pop(-1)
                    animation={}
                    move=(0, 0)
                    saveprogress("assets/levels/progressplaytest.prg")
                fade(wiin)
    if len(lvhistory)>1:
        for pos, (idd, typee) in list(lvv.obj.items()):
            bgg=lvv.bg.get(pos, (-1, None))
            if bgg[1] is not None and bgg[1].type=="export":
                def exportt():
                    ...
                    load("assets/levels/"+lvhistory[-2][0]+".lv")
                    player=lvhistory[-1][1]
                    if player in lvvll.obj:
                        lvvll.remove(lvvll.obj[player][0])
...
def createlv():
    global player, lvvll;
    lvvll=newlevel((15, 12), "root", color=(0, 0, 0));
    lvvll.add(obj("wall"), (0, 11));
    lvvll.add(obj("wall"), (0, 10));
    lvvll.add(obj("wall"), (0, 9));
    ...
    lvvll.add(obj("wall"), (1, 11));
    lvvll.add(obj("wall"), (1, 8));
    lvvll.add(obj("wall"), (1, 0));
    lvvll.add(obj("wall"), (2, 11));
    lvvll.add(obj("key", "3"), (2, 9));
    lvvll.add(obj("wall"), (2, 8));
    lvvll.add(obj("lock", "+"), (2, 0));
    lvvll.add(obj("wall"), (3, 11));
    lvvll.add(obj("lock", "1"), (3, 8));
    lvvll.add(obj("key", "7"), (3, 6));
    lvvll.add(obj("key", "7"), (3, 4));
    lvvll.add(obj("wall"), (3, 2));
    lvvll.add(obj("lock", "*"), (3, 0));
    lvvll.add(obj("wall"), (4, 11));
    lvvll.add(obj("wall"), (4, 8));
    lvvll.add(obj("wall"), (4, 2));
    lvvll.add(obj("lock", "1"), (4, 0));
    lvvll.add(obj("wall"), (5, 11));
    lvvll.add(obj("wall"), (5, 10));
    lvvll.add(obj("wall"), (5, 9));
    lvvll.add(obj("wall"), (5, 8));
    lvvll.add(obj("wall"), (5, 7));
    lvvll.add(obj("wall"), (5, 2));
    lvvll.add(obj("key", "*"), (5, 1));
    lvvll.add(obj("lock", "6"), (5, 0));
    lvvll.add(obj("wall"), (6, 11));
    lvvll.add(obj("wall"), (6, 7));
    lvvll.add(obj("key", "+"), (6, 5));
    lvvll.add(obj("wall"), (6, 2));
    lvvll.add(obj("key", "2"), (6, 1));
    lvvll.add(obj("wall"), (6, 0));
    lvvll.add(obj("wall"), (7, 11));
    lvvll.add(obj("key", "9"), (7, 9));
    lvvll.add(obj("lock", "8"), (7, 7));
    lvvll.add(obj("star"), (7, 5));
    lvvll.add(obj("key", "="), (7, 4));
    lvvll.add(obj("wall"), (7, 2));
    lvvll.add(obj("key", "="), (7, 1));
    lvvll.add(obj("wall"), (7, 0));
    lvvll.add(obj("wall"), (8, 11));
    lvvll.add(obj("wall"), (8, 7));
    lvvll.add(obj("key", "*"), (8, 5));
    lvvll.add(obj("wall"), (8, 2));
    lvvll.add(obj("wall"), (8, 0));
    lvvll.add(obj("wall"), (9, 11));
    lvvll.add(obj("wall"), (9, 10));
    lvvll.add(obj("wall"), (9, 9));
    lvvll.add(obj("wall"), (9, 8));
    lvvll.add(obj("wall"), (9, 7));
    lvvll.add(obj("wall"), (9, 4));
    lvvll.add(obj("wall"), (9, 3));
    lvvll.add(obj("wall"), (9, 2));
    lvvll.add(obj("wall"), (9, 0));
    lvvll.add(obj("wall"), (10, 11));
    lvvll.add(obj("wall"), (10, 8));
    lvvll.add(obj("wall"), (10, 4));
    lvvll.add(obj("win"), (10, 3));
    lvvll.add(obj("lock", "2"), (10, 2));
    lvvll.add(obj("wall"), (10, 0));
    lvvll.add(obj("wall"), (11, 11));
    lvvll.add(obj("lock", "2"), (11, 8));
    lvvll.add(obj("wall"), (11, 4));
    lvvll.add(obj("wall"), (11, 3));
    lvvll.add(obj("wall"), (11, 0));
    lvvll.add(obj("wall"), (12, 11));
    lvvll.add(obj("key", "6"), (12, 9));
    lvvll.add(obj("wall"), (12, 8));
    lvvll.add(obj("key", "4"), (12, 4));
    lvvll.add(obj("wall"), (12, 1));
    lvvll.add(obj("wall"), (12, 0));
    lvvll.add(obj("wall"), (13, 11));
    lvvll.add(obj("wall"), (13, 8));
    lvvll.add(obj("wall"), (13, 0));
    lvvll.add(obj("wall"), (14, 11));
    lvvll.add(obj("wall"), (14, 10));
    lvvll.add(obj("wall"), (14, 9));
    lvvll.add(obj("wall"), (14, 8));
    lvvll.add(obj("wall"), (14, 7));
    lvvll.add(obj("wall"), (14, 6));
    lvvll.add(obj("wall"), (14, 5));
    lvvll.add(obj("wall"), (14, 4));
    lvvll.add(obj("wall"), (14, 3));
    lvvll.add(obj("wall"), (14, 2));
    lvvll.add(obj("wall"), (14, 1));
    lvvll.add(obj("wall"), (14, 0));
    player=(3, 4)
#createlv(); save("assets/levels/4.lv")
load("assets/levels/w1-1.lv")
#load("assets/levels/w2.lv")
#save("assets/levels/w2.lv")
#saveprogress("assets/levels/progress1.prg")
#loadprogress("assets/levels/progress1.prg")
loadprogress("assets/levels/progressplaytest.prg")
#clearprogress("assets/levels/progress1.prg")
clock=pygame.time.Clock()
x=True
while x:
    move=None
        ...
        if ppp[1].type=="lv":
            if s==pygame.K_SPACE:
                ...
                def enter():
                    ...
                    load("assets/levels/"+ppp[1].value[0]+".lv")
                fade(enter)
        elif ppp[1].type=="levellock":
            if not checklvlock(ppp[1])[1]:
                def die():
                    global animation, move
                    load("assets/levels/"+lvhistory[-1][0]+".lv")
                    animation={}
                    move=(0, 0)
                fade(die)
    if s==pygame.K_r:
        undo.append(pickle.dumps({"level": lvvll, "objlvs": objlvs, "next_free": next_free, "player": player, "lvhistory": lvhistory}))
        def restart(): load("assets/levels/"+lvhistory[-1][0]+".lv")
        fade(restart)
